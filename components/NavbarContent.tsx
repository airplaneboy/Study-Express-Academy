        ...
        <Popover
          ...
          className={({ open }) =>
            classNames(
              ...
              `backdrop-blur-sm py-2 relative md:fixed inherit_width_height z-20 md:z-10 lg:overflow-y-visible transition-shadow duration-300  ${
                isScrolled ? 'shadow-md' : 'md:border-b border-gray-300'
              }`
            )
          }>
          {({ open }) => (
