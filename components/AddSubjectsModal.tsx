                  ...
                  return (
                    <div key={course._id}>
                      ...
                      {includes(selectedSubjects[index], course._id) ? (
                        <Checkbox checked={true} id={course._id} labelClassName='truncate select-none text-blue-800 '>
                          {course.title}
                        </Checkbox>
                      ) : (
                        <Checkbox id={course._id} labelClassName={'truncate select-none text-gray-800 '}>
                          {course.title}
                        </Checkbox>
                      )}
                    </div>
