  ...
  return (
    <WavyBackground blur={0} containerClassName='relative' className='z-[0] static' backgroundFill='#fff'>
      <section className='w-full bg-dot-black/[0.3] max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center min-h-screen px-6 md:px-10 lg:px-24'>
        ...
        <div className='inset-0 h-full w-full min-w-screen z-0 absolute pointer-events-none left-0 flex items-center justify-center bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]' />
        <div className='inset-0 h-full w-full min-w-screen z-0 absolute pointer-events-none bg-gradient-to-b from-transparent via-transparent to-white' />
