...
import Example from '@/components/lottie/example';
...
const HeroSection = () => {
  ...
  return (
    <WavyBackground blur={0} containerClassName='relative' className='z-[0] static' backgroundFill='#fff'>
      <section
        className={
          ' bg-dot-black/[0.2] max-w-7xl mx-auto flex flex-row justify-between items-center min-h-screen px-24'
        }>
        {/* <Example className='w-full left-0 blur-sm absolute' /> */}
        ...
        <div className='min-w-screen z-0 absolute pointer-events-none left-0 flex items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]' />
        <div className={sectionContentStyle}>
          <h1 className='text-[80px] leading-[1] font-extrabold bg-gradient-to-r from-teal-500 via-purple-500 to-blue-600 bg-clip-text text-transparent pb-3'>
