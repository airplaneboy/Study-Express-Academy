const CardListContentDescription = ({ contentDescription }: { contentDescription?: string }) => {
  return (
    <>
      {contentDescription && (
        <div className='w-full mb-10 flex flex-col gap-5 border-2 border-gray-700 text-gray-500 sm:bg-gray-200 sm:rounded-2xl mx-4 max-sm:px-2 max-sm:py-2 max-sm:pb-2 sm:p-4'>
