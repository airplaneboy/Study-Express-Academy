...
class Sparkle extends React.Component {
  ...
  drawSparkles() {
    ...
    this.sparkles.forEach((sparkle) => {
      ...
      if (sparkle.color) {
        ...
        self.sparkleContext.fillRect(sparkle.position.x, sparkle.position.y, sparkle.size, sparkle.size);
      }
  ...
  parentResizeObserver() {
    ...
    const isHorizontalWritingMode = parentStyle['writing-mode'] === 'horizontal-tb';
    const self = this;
    const ro = new ResizeObserver((entries) => {
      ...
      for (const entry of entries) {
        ...
        const [width, height] = isHorizontalWritingMode ? [inlineSize, blockSize] : [blockSize, inlineSize];
