...
const MainContent = ({ children }: { children: any }) => {
  ...
  return (
    <main className='flex-1 min-h-[calc(100vh-56px-56px-116.5px)] sm:min-h-[calc(100vh-64px-56px-50px)] md:min-h-[calc(100vh-64px-50px)]'>
      <div className='py-6 pb-28 px-2'>
