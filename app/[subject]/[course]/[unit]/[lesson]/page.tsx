const Lesson = () => {
  return (
    <div className='px-2 sm:px-8 lg:px-16 py-4 sm:py-8 md:py-4 md:text-center lg:text-left flex flex-col justify-evenly sm:justify-center lg:justify-evenly h-full tracking-tight'>
      ...
      <div className=' block h-[65px] sm:h-16 bg-white border-dashed sm:border-solid border-t-2 sm:border-t absolute sm:fixed md:absolute bottom-0 left-0 right-0 max-md:-translate-x-1/2 max-md:left-1/2 min-w-full' />
    </div>
  );
};
