const Lesson = () => {
  return (
    <div className='px-2 sm:px-8 lg:px-16 py-4 sm:py-8 md:py-4 md:text-center lg:text-left flex flex-col justify-evenly sm:justify-center lg:justify-evenly tracking-tight h-full'>
