      ...
      <div className='flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 '>
        <div className='mx-auto w-full max-w-sm lg:w-96'>
          <div>
            ...
            <h2 className='mt-6 text-4xl font-extrabold text-gray-900'>Sign in to your account</h2>
                ...
                <div className='mt-1 grid grid-cols-3 gap-3'>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <FcGoogle size='1.25rem' title='google-icon' />
                    </Link>
                  </div>
                </div>
              </div>
            ...
            <div className='mt-6'>
              <form action='#' method='POST' className=' max-md:px-4 '>
                ...
                <div className='space-y-3 mt-10'>
                  ...
                  <Button value='Sign In' classValue='' />
                </div>
              </form>
            </div>
          </div>
