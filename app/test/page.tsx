...
const NavbarSkeleton = () => {
  return (
    <>
      <div className='flex justify-evenly items-center md:gap-2 max-w-7xl mx-auto h-16 py-2 px-8 animate-pulse'>
        ...
        <div className='w-full h-full justify-center items-center flex'>
          <div className='h-full bg-gray-200 w-full max-md:max-w-[48px] flex-shrink-0'></div>
        </div>
