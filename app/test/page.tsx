...
//   HiOutlineChatBubbleBottomCenterText as HiOutlineChatBubbleBottomCenterText,
//   HiOutlineDocumentText as HiOutlineDocumentText,
//   HiOutlineHeart as HiOutlineHeart,
//   HiOutlineInbox as HiOutlineInbox,
//   HiBars3 as HiBars3,
//   HiOutlinePencilSquare as HiOutlinePencilSquare,
//   HiOutlineQuestionMarkCircle as HiOutlineQuestionMarkCircle,
//   HiOutlineReceiptRefund as HiOutlineReceiptRefund,
//   HiOutlineSparkles as HiOutlineSparkles,
//   HiOutlineTrash as HiOutlineTrash,
//   HiOutlineUsers as HiOutlineUsers,
//   HiXMark as HiXMark,
// } from '@heroicons/react/outline';
// import { HiChevronDown as HiChevronDown } from '@heroicons/react/solid';
                ...
                <div>
                  <div>
                    <span className='h-12 w-12 rounded-md flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600'>
                      <HiOutlineHeart className='h-6 w-6 text-white' aria-hidden='true' />
                    </span>
                  </div>
                  <div className='mt-6'>
            ...
            <div className='lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24'>
              <div className='px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2'>
                <div>
                  <div>
                    <span className='h-12 w-12 rounded-md flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600'>
                      <HiOutlineSparkles className='h-6 w-6 text-white' aria-hidden='true' />
                    </span>
                  </div>
                  <div className='mt-6'>
                    <h2 className='text-3xl font-extrabold tracking-tight text-gray-900'>
